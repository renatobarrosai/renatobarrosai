...
_Building the bridge between professional sound engineering and artificial intelligence — creating accessible tools for the future of human-computer interaction._
...
_"Technology should adapt to humans, not the other way around."_
...
| :--------------------------------------------------------------: | :----------------------------------------------: |
|                  Clone docs for offline/AI use                   |   Color scheme inspired by Brazilian Carnival    |
...
<p align="justify">
As someone who has worked with audio for over a decade, I understand the power of the human voice. Combined with modern AI (Whisper for STT, LLMs for intent, Kokoro for TTS), we can create computing experiences that are truly accessible — for people with motor disabilities, RSI, or anyone seeking a more natural interface.
</p>
...
**Building audio tools that solve real problems**
...
|                                 |                       |                  |
| :-----------------------------: | :-------------------: | :--------------: |
|         **Open Source**         |  **Human-Centered**   |  **Accessible**  |
| Professional tools for everyone | Hardware adapts to us | Voice is natural |
...
I'm interested in **collaborations** on Audio AI, **discussions** about voice interfaces,  
**opportunities** in Voice Technology, and **contributions** to accessibility-focused open source.
